...
- **A "Georgia" Scripture face** (`src/lib/typography.ts`, `--georgia` in `styles.css`), beside
  Garamond, System serif, and System sans — a recognizable, sturdier serif. Added by request.
