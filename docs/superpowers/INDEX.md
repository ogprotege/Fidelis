...
- [Documentation revamp design (2026-06-24)](specs/2026-06-24-documentation-revamp-design.md) — this docs overhaul: the seven-task plan that produced the current `docs/` structure and all new guide/history pages. ▢ in progress
...
- [Documentation revamp plan (2026-06-24)](plans/2026-06-24-documentation-revamp.md) — step-by-step implementation plan for the seven-task docs overhaul (this `docs/` restructure). ▢ in progress
